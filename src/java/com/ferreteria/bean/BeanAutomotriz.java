...
public class BeanAutomotriz {
    ...
    public void setProductoselec(Producto productoselec) {
        ...
        if (this.productoselec != null) {
            if (productoselec.getCodigo().equals("B004")) {
                descric = "Motor de 1200 con dos cilindros ";
            } else if (productoselec.getCodigo().equals("B005")) {
                descric = "Candelas para carros compactos.";
            } else if (productoselec.getCodigo().equals("B006")) {
                descric = "Frenos de discos para automovil medio";
            }
    ...
    public BeanAutomotriz() {
        product = listaProductos("A");
    }
