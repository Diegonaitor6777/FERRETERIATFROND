...
public class Beanmateriales {
    ...
    public void setProductoselec(Producto productoselec) {
        ...
        if (this.productoselec != null) {
            if (productoselec.getCodigo().equals("B025")) {
                descric = "Block de 1 pulgada. ";
            } else if (productoselec.getCodigo().equals("B026")) {
                descric = "Ladrillo de 2 pulgadas.";
            } else if (productoselec.getCodigo().equals("B027")) {
                descric = "Material en perfecto estado y realiza un cemento solido.";
            }
