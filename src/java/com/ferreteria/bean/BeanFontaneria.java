...
public class BeanFontaneria {
    ...
    public void setProductoselec(Producto productoselec) {
        ...
        if (this.productoselec != null) {
            if (productoselec.getCodigo().equals("B013")) {
                descric = "La tenaza tiene la capacidad de cortar alambre. ";
            } else if (productoselec.getCodigo().equals("B014")) {
                descric = "El cangrejo es una herramienta que se adapta a cualquier tuerca.";
            } else if (productoselec.getCodigo().equals("B015")) {
                descric = "La grifa sirve parar tratar temas de fontaneria";
            }
    ...
    public BeanFontaneria() {
        product = listaProductos("O");
    }
