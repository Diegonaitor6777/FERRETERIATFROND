 ...
 * @author Diegu
 */
public class BeanListaherramienta {
    ...
    public void setProductoselec(Producto productoselec) {
        ...
        if (this.productoselec != null) {
            if (productoselec.getCodigo().equals("B001")) {
                descric = "El martillo es una herramienta utilizada para golpear directamente o indirectamente una pieza. ";
            } else if (productoselec.getCodigo().equals("B002")) {
                descric = "Las pinzas son una herramienta utilizada para sujetar algo o bien funciona como palanca simples.";
            } else if (productoselec.getCodigo().equals("B003")) {
                descric = "Dispositivo o herramienta utilizado para hacer agujeros";
            }
    ...
    /**
     * Creates a new instance of BeanListaherramienta
     */
    public BeanListaherramienta() {
        product = listaProductos("H");
