...
public class BeanBanios {
    ...
    public void setProductoselec(Producto productoselec) {
        ...
        if (this.productoselec != null) {
            if (productoselec.getCodigo().equals("B007")) {
                descric = "Con la capacidad de poder lavar las manos sin gastar tanta agua. ";
            } else if (productoselec.getCodigo().equals("B008")) {
                descric = "Regadera ergonomica, con la capacidad de tener una dispersion uniforme.";
            } else if (productoselec.getCodigo().equals("B009")) {
                descric = "Inodoro moderon y adaptable";
            }
