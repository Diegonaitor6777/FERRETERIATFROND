...
public class Beaniluminacion {
    ...
    public void setProductoselec(Producto productoselec) {
        ...
        if (this.productoselec != null) {
            if (productoselec.getCodigo().equals("B019")) {
                descric = "Bombilla que brinda una luz amarilla y que tiene un alto consumo ";
            } else if (productoselec.getCodigo().equals("B020")) {
                descric = "Bombilla con luz blanca, sobre el cual genera mucho ahorro.";
            } else if (productoselec.getCodigo().equals("B021")) {
                descric = "La barra luminosa, perfecto foco, para alumbrar grandes areas.";
            }
