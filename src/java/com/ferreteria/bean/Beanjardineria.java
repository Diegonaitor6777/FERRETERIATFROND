...
public class Beanjardineria {
    ...
    public void setProductoselec(Producto productoselec) {
        ...
        if (this.productoselec != null) {
            if (productoselec.getCodigo().equals("B022")) {
                descric = "Herramienta utilizada para tratar la tierra. ";
            } else if (productoselec.getCodigo().equals("B023")) {
                descric = "Herramienta utilizada para cortar la grama de manera eficiente.";
            } else if (productoselec.getCodigo().equals("B024")) {
                descric = "Herramienta utilizada para cortar ramas";
            }
    ...
    public Beanjardineria() {
        product = listaProductos("J");
