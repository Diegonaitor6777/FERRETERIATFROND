...
public class Beanpintura {
    ...
    public void setProductoselec(Producto productoselec) {
        ...
        if (this.productoselec != null) {
            if (productoselec.getCodigo().equals("B031")) {
                descric = "Herramienta utilizada para pintar de una manera eficiente. ";
            } else if (productoselec.getCodigo().equals("B032")) {
                descric = "Difentes galones de pintura.";
            } else if (productoselec.getCodigo().equals("B033")) {
                descric = "Herramienta utilizada para pintar bordes o lugares estrechos";
            }
