...
public class Beanmuebles {
    ...
    public void setProductoselec(Producto productoselec) {
        ...
        if (this.productoselec != null) {
            if (productoselec.getCodigo().equals("B028")) {
                descric = "Comodo y se puede convertir en cama ";
            } else if (productoselec.getCodigo().equals("B029")) {
                descric = "Estanteria de gran tamanio.";
            } else if (productoselec.getCodigo().equals("B030")) {
                descric = "Mesa grande y con capacidad de albergar a 6 personas";
            }
