...
public class BeanFerreteria {
    ...
    public void setProductoselec(Producto productoselec) {
        ...
        if (this.productoselec != null) {
            if (productoselec.getCodigo().equals("B016")) {
                descric = "Herramientas usadas para abrir cualquier tipo de cerrojo ";
            } else if (productoselec.getCodigo().equals("B017")) {
                descric = "Llaves encargadas de abrir o son moldeables para adaptarse al cerrojo.";
            } else if (productoselec.getCodigo().equals("B018")) {
                descric = "Dispositivo que tiene la capacidad de abrir cerraduras europeas";
            }
    ...
    public BeanFerreteria() {
          product = listaProductos("C");
    }
